...
- **=Ý Side-by-Side Comparison**: Clean, GitHub-style diff view with syntax highlighting
...
- **=ñ Responsive Design**: Works seamlessly on desktop and mobile devices
...
- **=Ë One-Click Sharing**: Copy shareable URLs to clipboard instantly
